...
@Component({
  selector: 'app-review-training',
  templateUrl: './review-training.component.html',
  styleUrls: ['./review-training.component.css']
})
export class ReviewTrainingComponent implements OnInit {
  isLoading = false;
