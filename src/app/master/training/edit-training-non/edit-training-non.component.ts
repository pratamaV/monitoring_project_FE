...
@Component({
  selector: 'app-edit-training-non',
  templateUrl: './edit-training-non.component.html',
  styleUrls: ['./edit-training-non.component.css']
})
export class EditTrainingNonComponent implements OnInit {
